...
load('../wsc_raw_intensities_matlab_1906/ws_v9_WSC450_RI_BG.mat')


her1 = horzcat(wsc450_RI_PSMd_L_yfp(1:116,:));

Starting_point_PSMd_L(2,1) = Starting_point_PSMd_L(2,1);
...
save('../wsc_raw_intensities_matlab_1906/ws_v9_WSC450_RI_BG.mat')
